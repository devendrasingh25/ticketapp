  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden'>
      ...
      <div className='relative flex items-center justify-between pt-20 pb-10'>
        <p className='px-6 md:px-16 lg:px-24 overflow-hidden'>Now Showing </p>
        <button onClick={()=>navigate(('/movies'))} className='group flex items-center gap-2 tex-sm text-gray-300 cursor-pointer'>
            View All
